...
readonly REPO_URL="https://github.com/erffy-dots/starship.git"
readonly CONFIG_DIR="$HOME/.config/starship"
...
echo "Downloading Starship configuration files from GitHub..."

# Handle existing configuration
if [ -d "$CONFIG_DIR" ]; then
    echo "Existing Starship configuration detected at '$CONFIG_DIR'."
...
echo -e "WARNING: You need to add 'export STARSHIP_CONFIG=\"~/.config/starship/starship.toml\"' to your shell configuration file."

echo "You may need to install additional dependencies for Starship."
echo "Refer to the Starship documentation for more information."
